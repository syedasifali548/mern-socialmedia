        ...
        <Paper className={classes.paper}>
            <form autoComplete="off" 
                ...
                <div className={classes.fileInput}>
                    ...
                    type="file"
                    multiple={false}
                    onDone={({file})=>setPostData({...postData,selectedFile:file.base64})} /> </div>
                    <Button className={classes.buttonSubmit} variant='contained' color='primary' type='submit' size='large' fullWidth>Submit</Button>
                    <Button  variant='contained' color='secondary' type='submit' size='small' fullWidth onClick={clear}>Clear</Button>
            </form>
